...
public class SchoolTest {
  ...
  // This one must give a compilation error, because we should be able to access the DB is private
  // and cannot be accessed directly from outside
  /*
  @Test
  public void tryPut() {
    school.schoolDB.put(6, Arrays.asList("Bart", "Lisa"));
  }
  */

  // But accessing the DB through the db() method, we can modify directly...
  // Mmmm, don't know whether there is a way to avoid that without breaking anything...
  @Test
  public void tryPutDB() {
    school.db().put(6, Arrays.asList("Bart", "Lisa"));
    assertThat(school.db().get(6)).hasSize(2).contains("Bart", "Lisa");
  }
}
